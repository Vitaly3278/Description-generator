...
На русском языке. Не используй placeholder тексты.""",
...
На русском языке, живым и продающим стилем. Не используй placeholder тексты.""",
